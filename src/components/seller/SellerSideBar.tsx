...
import { LayoutDashboard, Package, ShoppingCart, MessageSquare, LogOut, BarChart3, UserCircle } from "lucide-react";
...
export function SellerSideBar() {
    ...
    const navLinks = [
        ...
        { to: "/seller/profile", name: "Profile", icon: <UserCircle className="h-5 w-5" />, isActive: path.pathname.includes("profile") },
    ]
